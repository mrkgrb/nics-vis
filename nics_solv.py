...
def create_colored_map_with_coords(results, results2, filename, image_width, colors, vmin, vmax, coords, bonds, atom_colors, atom_sizes, iso_cont, nics_r, d_type, ticks_num, linew, no_legend, iso_not_zz, dipole_moments, or_atm, spec_atom):
    """
